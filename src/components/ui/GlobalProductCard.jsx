...
export const GlobalProductCard = ({
  ...
  const handleAddToCartClick = () => {
    if (onAddToCart) {
      onAddToCart(id); // ✅ Trigger parent cart logic with product id
    }
  };
  ...
  return (
    <div
      ...
      className="
        ...
        sm:rounded-3xl overflow-hidden bg-white
        snap-center
      "
    >
      {/* Image */}
      <div className="relative w-full h-[160px] sm:h-[271px] rounded-t-[16px] overflow-hidden">
        ...
        <div className="absolute top-2 right-2 sm:top-4 sm:right-3 flex justify-end">
          ...
          >
            <img
              src={wish ? "/heart-red.svg" : "/heart.svg"}
              alt="wishlist"
      ...
      {/* Content */}
      <div className="flex flex-col items-start gap-1 sm:gap-2 p-2 sm:p-4 flex-grow">
